...
builder.Services.AddSwaggerGen(c =>
{
    c.SwaggerDoc("v1", new OpenApiInfo
    {
        ...
        Version = "v1",
        Description = "Notification management microservice for SpendSmart platform"
    });
...
builder.Services.AddScoped<INotificationRecordService, NotificationRecordService>();

builder.Services.AddHttpClient<IUserHttpClient, UserHttpClient>(client =>
{
    client.BaseAddress = new Uri(builder.Configuration["AuthApi:BaseUrl"] ?? "http://localhost:5001");
